...
The MCP server simply doesn't expose that data field. To get your personal track count, you'd need to check your profile directly on the Safecast website. It might be worth adding a user filter...
...
This seems not correct.. How can we fix that?
